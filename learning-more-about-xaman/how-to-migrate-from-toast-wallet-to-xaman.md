...
If you are considering moving your account into Xaman, the safest way to protect your funds is to [**create a** **new XRPL account**](../getting-started-with-xaman/your-first-xrp-ledger-account/how-to-create-an-xrpl-account.md) using Xaman, then move your assets from your XRPL account managed by Toast wallet, over to your new account managed by Xaman.
...
{% content-ref url="../getting-started-with-xaman/importing-your-account/...with-a-family-seed.md" %}
[...with-a-family-seed.md](../getting-started-with-xaman/importing-your-account/...with-a-family-seed.md)
{% endcontent-ref %}
