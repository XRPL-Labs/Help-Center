...
* Xumm only displays the secret number once, when the account is generated. There is no way to access or view it after it is initially displayed. No one, (other than you) will ever see the secret numbers after the account has been created.
* After a new account is generated, the [**secret numbers are encrypted**](../../security-and-xumm/all-about-security/upgrading-your-encryption.md) and immediately stored in Xumm. The AES 256-GCM algorithm we use to encrypt it is exceptionally secure.  &#x20;
