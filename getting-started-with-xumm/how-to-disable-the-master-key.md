...
2\) Press the ![](<../.gitbook/assets/image (1).png>) button then press **Open in Xumm App** and sign in with the account the you would like to disable your Master key on.
