...
In theory we could invest millions of dollars in a CRQC and try to crack your account secret via the Sign in signatures.  (We just updated our encryption algorithms (AES-GCM) So it's quantum resistant except if we (XRPL Labs) would act in bad faith and have access to a q (AES-GCM) uantum computer.
