...
* This means that you must have [**imported**](/broken/pages/5BtKfbOhGYDqyiQjU93Z) both of your accounts (the one being deleted and the one that will receive the deleted account’s XRP) into Xumm using the account secrets. (Secret numbers / Family seed / Mnemonic)
