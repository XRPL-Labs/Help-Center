...
Since the master key of your vanity account has been disabled, there is only one way to access it... by your regular key account. When the time comes to replace your phone, you simply need to install Xaman on it, import your vanity r-address into Xaman in [_read only_](/broken/pages/wK33oGskwmL6CUJJWMax) mode, then [import your regular key account](/broken/pages/5BtKfbOhGYDqyiQjU93Z) into Xaman in with full access. Xaman will recognize the regular key account and allow you to sign on you vanity account.
